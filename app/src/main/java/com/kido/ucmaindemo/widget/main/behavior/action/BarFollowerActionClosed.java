...
public class BarFollowerActionClosed extends AbsBarOffsetAction {

    private static final String TAG = "BarFollowerActionClosed";

    public BarFollowerActionClosed() {
    }
    ...
    public void offsetChildAsNeeded(CoordinatorLayout parent, View child, View dependency) {
        ...
        int childStartTransY = -(dependency.getMeasuredHeight() - AbsActionHelper.getHeaderHeight(dependency) - AbsActionHelper.getFooterHeight(dependency));
        int childStopTransY = -(dependency.getMeasuredHeight() - AbsActionHelper.getFooterHeight(dependency));
