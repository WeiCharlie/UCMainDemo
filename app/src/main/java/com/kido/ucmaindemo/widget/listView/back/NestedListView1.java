...
public class NestedListView1 extends ListView implements NestedScrollingChild {
    ...
    public NestedListView1(Context context) {
        super(context);
        init();
    }

    public NestedListView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NestedListView1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public NestedListView1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
