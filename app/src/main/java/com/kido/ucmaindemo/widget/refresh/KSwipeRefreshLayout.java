 ...
 * <p>
 * <p>Added Terminal State</p>
 * <p>
 * The CustomSwipeRefreshLayout should be used whenever the user can refresh the
 * contents of a view via a vertical swipe gesture. The activity that
 * instantiates this view should add an OnRefreshListener to be notified
 * whenever the swipe to refresh gesture is completed. The CustomSwipeRefreshLayout
 ...
 * width and the height supplied in this layout. The CustomSwipeRefreshLayout does not
 * provide accessibility events; instead, a menu item must be provided to allow
 * refresh of the content wherever this gesture is used.
 * </p>
 */
public class KSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = KSwipeRefreshLayout.class.getSimpleName();
    ...
    // added by Kido
    private static final int DEFAULT_INDICATOR_NORMAL_BACKGROUND = 0xff52ace5;
    private static final int DEFAULT_INDICATOR_NORMAL_FOREGROUND = 0xffffffff;
    ...
    public KSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mIndicatorNormalBackground = a2.getColor(R.styleable.KSwipeRefreshLayout_ksrl_indicator_normal_background, DEFAULT_INDICATOR_NORMAL_BACKGROUND);
        mIndicatorNormalForeground = a2.getColor(R.styleable.KSwipeRefreshLayout_ksrl_indicator_normal_foreground, DEFAULT_INDICATOR_NORMAL_FOREGROUND);
    ...
    /**
     * Set a callback to override {@link KSwipeRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    public interface OnRefreshListener {
        ...
        /**
         * Called when a swipe gesture triggers a terminal.
         */
        void onTerminal();
    }

    /**
     * Classes that wish to override {@link KSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link KSwipeRefreshLayout#canChildScrollUp()} method
         * is called to allow the implementer to override its behavior.
         *
         * @param parent CustomSwipeRefreshLayout that this callback is overriding.
         * @param child  The child view of CustomSwipeRefreshLayout.
         * @return Whether it is possible for the child view of parent layout to scroll up.
         */
        boolean canChildScrollUp(KSwipeRefreshLayout parent, @Nullable View child);
    }
}
