 ...
 * @create_time 17/6/2 20:34
 */

public class NestedListView4 extends ListView {

    private int listViewTouchAction;
    private static final int MAXIMUM_LIST_ITEMS_VIEWABLE = 999;

    public NestedListView4(Context context, AttributeSet attrs) {
        super(context, attrs);
