 ...
 * @create_time 17/6/3 11:32
 */

public class NestedListView5 extends ListView implements NestedScrollingChild {

    private static final String TAG = "NestedListView5";
    ...
    public NestedListView5(Context context) {
        super(context);
        init();
    }

    public NestedListView5(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NestedListView5(Context context, AttributeSet attrs, int defStyleAttr) {
