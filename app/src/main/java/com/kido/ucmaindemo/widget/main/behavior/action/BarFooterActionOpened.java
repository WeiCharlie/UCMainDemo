...
public class BarFooterActionOpened extends AbsBarOffsetAction {

    private static final String TAG = "BarFooterActionOpened";

    public BarFooterActionOpened() {
    }
    ...
    public void offsetChildAsNeeded(CoordinatorLayout parent, View child, View dependency) {
        ...
        int childOffsetRange = -(dependency.getMeasuredHeight() - AbsActionHelper.getHeaderHeight(dependency));
