...
public class BarHeaderActionClosed extends AbsBarOffsetAction {
    private static final String TAG = "BarHeaderActionClosed";


    public BarHeaderActionClosed() {
    }
    ...
    public void offsetChildAsNeeded(CoordinatorLayout parent, View child, View dependency) {
        ...
        int childStartTransY = AbsActionHelper.getHeaderHeight(dependency);
        int childStopTransY = 0;
